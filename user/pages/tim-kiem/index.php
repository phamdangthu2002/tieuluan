    ...
    <div class="pagination-container">
        <div class="pagination">
            ...
            <?php if ($page_number > 1): ?>
                <a href="index.php?pages=tim-kiem&tu-khoa=<?= $tu_khoa ?>&page=1" class='pagination-link'>Đầu trang</a>
            <?php endif ?>


            <?php if ($page_number > 1): ?>
                <a href="index.php?pages=tim-kiem&tu-khoa=<?= $tu_khoa ?>&page=<?= $page_number - 1 ?> "
            ...
            <?php for ($i = max(1, $page_number - 2); $i <= min($page_number + 2, $total_pages); $i++): ?>
                <a href="index.php?pages=tim-kiem&tu-khoa=<?= $tu_khoa ?>&page=<?= $i ?> " class='pagination-link'
            ...
            <?php if ($page_number < $total_pages): ?>
                <a href="index.php?pages=tim-kiem&tu-khoa=<?= $tu_khoa ?>&page=<?= $total_pages ?> "
